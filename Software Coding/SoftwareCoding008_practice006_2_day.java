...
public class SoftwareCoding008_practice006_2_day {

	public static void main(String[] args) throws IOException {
			File k34_f = new File("C:\\Users\\kopo\\Desktop\\kopo34 과제\\소프트웨어 코딩\\StockDailyPrice.csv");// 해당 위치에 있는 StockDailyPrice.csv파일을 읽는다.
			BufferedReader k34_br = new BufferedReader(new FileReader(k34_f));// BufferedReader 사용해 읽는다.
			
			File k34_f1 = new File("C:\\Users\\kopo\\Desktop\\kopo34 과제\\소프트웨어 코딩\\20150112.csv");// 해당 위치에 20150112.csv 파일을 생성한다.
			...
			int k34_wcnt = 0;// 20150112 일자만 카운트
			while ((k34_readTxt = k34_br.readLine()) != null) {// 읽을 문자열이 있으면(null이 아니면) 반복한다.
				...
				if(k34_field.length > 2 && k34_field[1].equals("20150112")) {// 일자를 구분하기 위한 조건문
																		     // 일자는 두번째 필드에 있다.
					...
					k34_bw.newLine();// 개행
					k34_wcnt++;// 20150112 일자 카운트에 1씩 더한다.
				}
