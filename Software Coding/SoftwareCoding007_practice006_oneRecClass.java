...
public class SoftwareCoding007_practice006_oneRecClass{
	...
	SoftwareCoding007_practice006_oneRecClass(String k34_name, int k34_kor, int k34_eng, int k34_mat) {// 생성자 호출 시 4개의 매개변수를 넣는다.
